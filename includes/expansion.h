...
char 		*exp_math(t_token* tok, t_core *shell);
char 		*no_exp(t_token* tok, t_core *shell);
char 		*exp_cmd_subs(t_token* tok, t_core *shell);
char 		*exp_param(t_token* tok, t_core *shell);
char 		*exp_tilde(t_token* tok, t_core *shell);
char 		*exp_error(t_token* tok, t_core *shell);
char 		*cmd_substitution_expansion(t_token* tok, t_core *shell);
