...
/*   Updated: 2020/01/28 18:35:55 by arsciand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_lst			*expansion_lexer(t_lexer *lexer, t_lst *l_tok);
t_lst			*exp_dbparen
					(t_lexer *lexer, enum e_estate id, int len, t_lst *l_tok);
t_lst			*exp_paren_lexer
					(t_lexer *lexer, enum e_estate id, int len, t_lst *l_tok);
t_lst			*exp_bracket_lexer
					(t_lexer *lexer, enum e_estate id, int len, t_lst *l_tok);
t_lst			*exp_dollar_lexer
					(t_lexer *lexer, enum e_estate id, int len, t_lst *l_tok);
t_lst			*exp_tilde_lexer
					(t_lexer *lexer, enum e_estate id, int len, t_lst *l_tok);
t_lst			*exp_hook
					(t_lexer *lexer, enum e_estate id, int len, t_lst *l_tok);
t_lst			*quote_lexer(t_lexer *lexer, t_lst *l_tok);
t_lst			*dbquote_lexer(t_lexer *lexer, t_lst *l_tok);
t_lst			*bquote_lexer(t_lexer *lexer, t_lst *l_tok);
