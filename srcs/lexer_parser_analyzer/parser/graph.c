...
/*   Updated: 2020/01/28 21:06:40 by arsciand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	static enum e_pstate tab_good_type[] = {P_NEWLINE, P_WORD, ALL_REDIRECT
		, P_ASSIGN, P_IONUMBER, P_PIPE, P_AND, P_END, P_SEMICOLON, P_ANDIF
		, P_ORIF, P_ERROR};
...
{
	static enum e_pstate tab_good_type[] = {ALL_REDIRECT, P_ERROR};
